...
allExamples = concat
  ...
  , examples (datetime (2013, 2, 12, 15, 10, 0) Minute)
             [ "15:10"
             , "15:10ч"
             , "в 15 и 10"
             , "15ч и 10 мин"
             , "3:10 следобед"
             , "3 часа и 10 минути следобед"
             , "3ч и 10 минути следобед"
             ]
  ...
  , examples (datetime (2013, 4, 25, 16, 0, 0) Minute)
             [ "25 април в 4:00 следобед"
             , "25 април в 4:00 през деня"
             , "25 април в 16:00"
             , "25 април в 16:00 часа"
             ]
  , examples (datetime (2013, 4, 25, 16, 0, 0) Hour)
             [ "25 април в 16ч"
             , "25 април в 16"
             , "25 април в 4 следобед"
             , "25 април в четири следобед"
             , "25 април в 16 часа"
             , "25 април в 16ч."
             , "25ти април в 16ч."
             , "25. април в 16ч."
  ...
  , examples (datetime (2013, 2, 11, 22, 00, 00) Hour)
             [ "снощи в 10"
             , "снощи в 10ч"
             , "снощи в 10ч нощта"
             , "снощи в 10 часа през нощта"
             , "снощи в десет часа през нощта"
             ]
  , examples (datetime (2019, 2, 1, 0, 0, 0) Month)
             [ "февруари през 2019"
  ...
  , examples (datetime (2019, 1, 1, 0, 0, 0) Year)
             [ "през 2019та"
             , "през 2019г"
             ]
  ...
  , examples (datetime (2013, 2, 13, 11, 30, 0) Minute)
             [ "сряда, 11:30"
             , "сряда 11:30"
             , "сряда 11:30 предиобед"
             , "сряда 11:30 преди обяд"
             ]
  ...
  , examples (datetimeInterval
      ((2013, 3, 29, 18, 0, 0), (2013, 4, 1, 0, 0, 0)) Hour)
             [ "последния уикенд на март"
             , "последният уикенд от март"
             ]
  , examples (datetime (2013, 4, 24, 0, 0, 0) Day)
             [ "последната сряда на април"
             , "последната сряда от април"
             ]
  , examples (datetime (2013, 4, 30, 0, 0, 0) Day)
             [ "последния вторник на април"
             ]
  , examples (datetime (2013, 2, 12, 23, 59, 0) Minute)
             [ "последната минута на вечерта"
             ]
  ...
  , examples (datetime (2013, 12, 31, 23, 0, 0) Hour)
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 21, 0, 0), (2013, 2, 12, 0, 0, 0)) Hour)
             [ "късно снощи"
             , "късно вчера"
             , "късно вечерта вчера"
             ]
  ...
  , examples (datetime (2013, 3, 5, 0, 0, 0) Day)
             [ "4тия ден след втори март"
             , "4тия ден след 2 март"
             , "четвъртия ден след втори март"
             ]
  , examples (datetimeOpenInterval After (2013, 2, 26, 0, 0, 0) Day)
             [ "след две седмици"
             ]
  , examples (datetimeOpenInterval After (2013, 2, 22, 4, 0, 0) Hour)
             [ "след 10 дни"
             ]
  , examples (datetimeOpenInterval Before (2013, 2, 2, 4, 0, 0) Hour)
             [ "преди 10 дни"
             ]
  , examples (datetime (2013, 2, 1, 0, 0, 0) Day)
             [ "първия ден от този февруари"
             ]
  , examples (datetime (2013, 2, 28, 0, 0, 0) Day)
             [ "последния ден от февруари"
             , "последния ден от този февруари"
             ]
  , examples (datetime (2013, 2, 18, 0, 0, 0) Day)
             [ "третия понеделник след началото на месеца"
             ]
  , examples (datetime (2019, 1, 1, 0, 0, 0) Year)
             [ "2019г"
             , "2019г."
  ...
  , examples (datetime (2013, 4, 13, 0, 0, 0) Day)
             [ "13-ти април"
             ]
  , examples (datetime (2013, 3, 13, 0, 0, 0) Day)
             [ "13 март"
             , "на 13 март"
             , "на 13ти март"
             , "13.03.2013"
  ...
  , examples (datetime (2013, 2, 12, 10, 35, 0) Minute)
             [ "в 10:35"
             , "в 10 и 35"
  ...
  , examples (datetime (2013, 2, 12, 13, 35, 10) Second)
             [ "13ч, 35мин и 10 сек"
             , "13:35:10"
             , "13:35:10ч"
             ]
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 11, 0, 0), (2013, 2, 11, 14, 0, 0)) Hour)
             [ "наобед"
             , "на обяд"
             , "обяд"
             , "по обяд"
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 5, 0, 0), (2013, 2, 11, 10, 0, 0)) Hour)
             [ "сутрин"
             , "тази сутрин"
             , "сутринта"
             , "през сутринта"
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 4, 0, 0), (2013, 2, 11, 9, 0, 0)) Hour)
             [ "рано сутрин"
             , "рано сутринта"
             ]
  , examples (datetimeInterval
      ((2013, 2, 11, 7, 0, 0), (2013, 2, 11, 12, 0, 0)) Hour)
             [ "предиобед"
             , "преди обяд"
             , "преди обед"
             ]
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 21, 0, 0), (2013, 2, 12, 7, 0, 0)) Hour)
             [ "нощем"
             , "нощта"
             , "през нощта"
             , "тази нощ"
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 7, 0, 0), (2013, 2, 11, 22, 0, 0)) Hour)
             [ "денем"
             , "през деня"
             ]
  , examples (datetime (2013, 2, 11, 22, 35, 0) Minute)
             [ "единайсе часа без двайсе и пет минути вечерта"
             ]
  , examples (datetimeInterval
      ((2013, 2, 11, 9, 0, 0), (2013, 2, 11, 12, 0, 0)) Hour)
             [ "след закуска"
             ]
  , examples (datetimeInterval
      ((2013, 2, 11, 19, 0, 0), (2013, 2, 11, 21, 0, 0)) Hour)
             [ "след вечеря"
             ]
  , examples (datetimeInterval
      ((2013, 2, 11, 17, 0, 0), (2013, 2, 11, 21, 0, 0)) Hour)
             [ "след работа"
             ]
  , examples (datetimeInterval
      ((2013, 2, 11, 15, 0, 0), (2013, 2, 11, 21, 0, 0)) Hour)
             [ "след училище"
             ]
  ...
  , examples (datetime (2013, 2, 11, 10, 35, 0) Minute)
             [ "10 и 35 сутринта"
             , "сутринта в 10 и 35"
  ...
  , examples (datetime (2013, 2, 11, 3, 0, 0) Hour)
             [ "3 през нощта"
             , "3 нощем"
             , "нощем в 3"
             , "нощта в 3"
  ...
  , examples (datetimeInterval
      ((2013, 2, 15, 18, 0, 0), (2013, 2, 18, 0, 0, 0)) Hour)
             [ "този уикенд"
             ]
  , examples (datetimeInterval
      ((2013, 2, 15, 22, 0, 0), (2013, 2, 25, 0, 0, 0)) Hour)
             [ "следващия уикенд"
             ]
  , examples (datetimeInterval
      ((2013, 2, 8, 18, 0, 0), (2013, 2, 11, 0, 0, 0)) Hour)
             [ "миналия уикенд"
             , "предходния уикенд"
             , "последния уикенд"
             , "предния уикенд"
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 0, 0, 0), (2013, 2, 17, 0, 0, 0)) Day)
             [ "цялата седмица"
             , "цяла седмица"
             ]
  , examples (datetimeInterval
      ((2013, 2, 12, 0, 0, 0), (2013, 2, 17, 0, 0, 0)) Day)
             [ "останалата седмица"
             ]
  , examples (datetimeInterval
      ((2013, 6, 21, 0, 0, 0), (2013, 9, 24, 0, 0, 0)) Day)
             [ "това лято"
             , "лятото"
             ]
  , examples (datetimeInterval
      ((2014, 6, 21, 0, 0, 0), (2014, 9, 24, 0, 0, 0)) Day)
             [ "следващото лято"
             ]
  , examples (datetimeInterval
      ((2013, 12, 21, 0, 0, 0), (2013, 3, 21, 0, 0, 0)) Day)
             [ "тази зима"
             , "зимата"
             ]
  , examples (datetimeInterval
      ((2013, 9, 23, 0, 0, 0), (2013, 12, 22, 0, 0, 0)) Day)
             [ "тази есен"
             , "есента"
             ]
  , examples (datetimeInterval
      ((2013, 3, 20, 0, 0, 0), (2013, 6, 22, 0, 0, 0)) Day)
             [ "тази пролет"
             , "пролетта"
             ]
  , examples (datetime (2013, 2, 12, 10, 0, 0) Week)
             [ "точно в 10"
             , "точно в 10ч"
             , "около 10"
             , "точно 10"
  ...
  , examples (datetimeInterval
      ((2013, 3, 10, 0, 0, 0), (2013, 3, 12, 0, 0, 0)) Day)
             [ "март от 10. до 12."
             , "10 - 12 март"
             , "10 до 12 март"
             , "10ти до 12ти март"
  ...
  , examples (datetimeInterval
      ((2013, 3, 10, 11, 0, 0), (2013, 3, 12, 15, 0, 0)) Hour)
  ...
  , examples (datetimeInterval
      ((2013, 2, 12, 10, 0, 0), (2013, 2, 12, 15, 0, 0)) Hour)
             [ "10ч-15ч"
             , "от 10ч до 15ч"
             , "от 10 до 15"
             , "между 10 и 15"
  ...
  , examples (datetimeOpenInterval Before (2012, 2, 12, 11, 0, 0) Hour)
             [ "сутрин до 11"
             , "сутринта до 11"
             , "сутрин преди 11"
             , "преди 11"
  ...
  , examples (datetimeOpenInterval After (2012, 2, 12, 11, 0, 0) Hour)
             [ "сутрин след 11"
             , "след 11"
             ]
  , examples (datetimeOpenInterval After (2012, 2, 13, 10, 0, 0) Hour)
             [ "утре след 10"
             , "утре след 10 сутринта"
             ]
  , examples (datetimeOpenInterval Before (2012, 2, 13, 22, 0, 0) Hour)
             [ "утре след 10 вечерта"
             ]
  , examples (datetimeInterval
      ((2013, 3, 1, 0, 0, 0), (2013, 3, 11, 0, 0, 0)) Day)
             [ "началото на март"
             , "в началото на март"
             , "през началото на март"
             ]
  , examples (datetimeInterval
      ((2013, 3, 10, 0, 0, 0), (2013, 3, 22, 0, 0, 0)) Day)
             [ "в средата на март"
             , "средата на март"
             ]
  , examples (datetimeInterval
      ((2013, 3, 21, 0, 0, 0), (2013, 4, 1, 0, 0, 0)) Day)
             [ "в края на март"
             , "в краят на март"
             , "краят на март"
             ]
  , examples (datetimeInterval
      ((2013, 2, 21, 0, 0, 0), (2013, 3, 1, 0, 0, 0)) Day)
             [ "в края на месеца"
             , "краят на месецът"
             ]
  , examples (datetimeInterval
      ((2013, 2, 12, 4, 30, 0), (2013, 3, 1, 0, 0, 0)) Day)
             [ "до края на месеца"
             ]
  , examples (datetimeInterval
      ((2013, 2, 1, 0, 0, 0), (2013, 2, 11, 0, 0, 0)) Day)
             [ "началото на месеца"
             , "в началото на месецът"
             ]
  , examples (datetimeInterval
      ((2013, 1, 1, 0, 0, 0), (2013, 4, 1, 0, 0, 0)) Day)
  ...
  , examples (datetimeInterval
      ((2013, 9, 1, 0, 0, 0), (2014, 1, 1, 0, 0, 0)) Day)
             [ "края на годината"
             , "в краят на годината"
             , "в края на 2013г"
             , "в края на 2013та"
  ...
  , examples (datetimeInterval
      ((2013, 2, 11, 0, 0, 0), (2013, 2, 14, 0, 0, 0)) Day)
             [ "началото на седмицата"
             , "началото на тази седмица"
             , "в началото на седмицата"
             ]
  , examples (datetimeInterval
      ((2013, 2, 13, 0, 0, 0), (2013, 2, 16, 0, 0, 0)) Day)
  ...
  , examples (datetimeInterval
      ((2013, 2, 15, 0, 0, 0), (2013, 2, 18, 0, 0, 0)) Day)
             [ "края на седмицата"
  ...
  , examples (datetimeInterval
      ((2013, 2, 18, 0, 0, 0), (2013, 2, 21, 0, 0, 0)) Day)
  ...
  , examples (datetimeInterval
      ((2013, 2, 20, 0, 0, 0), (2013, 2, 23, 0, 0, 0)) Day)
             [ "в средата на по-следващата седмица"
             ]
  , examples (datetimeInterval
      ((2013, 2, 8, 0, 0, 0), (2013, 2, 11, 0, 0, 0)) Day)
  ...
  , examples (datetimeInterval
      ((2013, 2, 12, 4, 20, 0), (2013, 2, 12, 4, 30, 0)) Minute)
             [ "миналите 10 минути"
  ...
  , examples (datetimeOpenInterval Before (2012, 2, 12, 4, 20, 0) Minute)
             [ "преди 10 минути"
             , "10 минути преди сега"
             ]
  , examples (datetimeOpenInterval After (2012, 2, 12, 4, 40, 0) Minute)
             [ "след 10 минути"
             , "10 минути след сега"
             ]
  , examples (datetimeInterval
      ((2013, 2, 12, 4, 30, 0), (2013, 2, 12, 7, 15, 0)) Minute)
  ...
  , examples (datetime (2013, 2, 12, 9, 50, 0) Minute)
             [ "10 минути преди 10ч"
             ]
  , examples (datetimeInterval
      ((2013, 2, 12, 10, 0, 0), (2013, 2, 12, 10, 10, 0)) Minute)
  ...
  , examples (datetime (2013, 2, 12, 20, 30, 0) Minute)
  ...
  , examples (datetime (2013, 2, 4, 0, 0, 0) Day)
             [ "миналия понеделник"
             , "понеделник миналата седмица"
             , "миналата седмица в понеделник"
             ]
  , examples (datetime (2013, 2, 11, 0, 0, 0) Day)
             [ "този понеделник"
             , "тази седмица в понеделник"
             , "понеделник тази седмица"
             ]
  , examples (datetime (2013, 2, 12, 0, 0, 0) Day)
             [ "днес"
             , "този вторник"
  ...
  , examples (datetime (2013, 2, 13, 0, 0, 0) Day)
             [ "тази сряда"
             , "тази седмица в сряда"
             , "тази сряда тази седмица"
             ]
  , examples (datetime (2013, 2, 19, 0, 0, 0) Day)
             [ "следващия вторник"
             , "следващият вторник"
  ...
  , examples (datetime (2013, 3, 1, 0, 0, 0) Day)
             [ "по-следващия петък"
             , "по-следващата седмица в петък"
             , "петък по-следващата седмица"
             ]
  , examples (datetime (2014, 3, 1, 0, 0, 0) Month)
             [ "следващия март"
             , "следващият март"
  ...
  , examples (datetime (2013, 3, 20, 0, 0, 0) Day)
             [ "20-ти следващия месец"
             , "20ти следващия месец"
             , "20. следващия месец"
             ]
  , examples (datetime (2013, 2, 20, 0, 0, 0) Day)
             [ "20ти този месец"
