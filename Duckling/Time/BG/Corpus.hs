...
allExamples = concat
  ...
  , examples (datetime (2013, 2, 12, 19, 1, 0) Minute)
             [ "19:01"
             , "19 01"
             , "19ч01"
             , "19:01ч"
             , "19ч и 1 мин"
             , "7:01 следобед"
             , "7 часа и 1 минута следобед"
             , "7ч и 1 минута следобед"
             ]
  ...
  --            [ "следващия вторник"
  --            , "следващият вторник"
  --            , "около следващия вторник"
  --            , "около следващият вторник"
  --            ]
  -- , examples (datetime (2013, 2, 20, 0, 0, 0) Day)
  --            [ "следващата сряда"
  --            , "около следващата сряда"
  --            ]
